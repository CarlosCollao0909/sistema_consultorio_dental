<h1 class="mb-6 text-3xl font-bold tracking-tight text-slate-800">Registrar Nueva Especialidad</h1>
...
<div class="rounded-xl border border-slate-200 bg-white p-6 shadow-md md:p-8">
    ...
    <form action="/admin/specialties/create" method="POST" class="space-y-6">
